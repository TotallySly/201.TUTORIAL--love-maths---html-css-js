...
function checkAnswer() {
    ...
    if (isCorrect) {
        ...
        alert(`Your answer of ${userAnswer} is incorrect. The correct answer is ${calculatedAnswer[0]}`)
...
/**
 * Gets the current tally of incorrect scores from the DOM and increments it by one.
 */
